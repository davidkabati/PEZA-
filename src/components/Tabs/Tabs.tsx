...
const Tabs = ({ text1, text2 }: Props) => {
  const [active, setActive] = useState<string>(text1);

  return (
    <Box style={styles.container}>
      <TouchableOpacity onPress={() => setActive(text1)} activeOpacity={1} style={styles.tab}>
      ...
      <TouchableOpacity onPress={() => setActive(text2)} activeOpacity={1} style={styles.tab}>
